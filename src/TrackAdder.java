 ...
 * TrackAdder.java
 * 
 * Created 2009-03-03 by Waqas Javed.
 * ------------------------------------------------------------------
 */
...
public class TrackAdder extends JDialog implements ActionListener {
	...
	public TrackAdder(JFrame owner, File file, PFrame f) {
		super(owner);
		frame = f;
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("OK")) {
			...
			((LayoutManager) frame).aNode[0][0].addGraph(yy);
